    ...
    <div className='mt-9 w-[65%]'>
        {
            blogs.map((blog ,index)=>{
                return (
                    <div key={index} className='w-full border-b-[1px] border-[#c2c2c2] pb-9 flex items-center justify-start gap-3'>
                        ...
                        <div className='bg-zinc-200 h-40 w-[30%] overflow-hidden rounded-md'>
